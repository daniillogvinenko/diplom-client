...
import cls from "./ReviewsSectionTablet.module.scss";
interface ReviewsSectionTabletProps {
    className?: string;
}

export const ReviewsSectionTablet = ({ className }: ReviewsSectionTabletProps) => {
    return (
