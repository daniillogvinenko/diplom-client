            ...
            <div className={cls.pageContent}>
                <div className="container">
                    ...
                    <Text textType="text" tagType="p">
                        ...
                        защищена. Никто, в том числе интернет-магазин https://dominopizza.ru, не может получить
                        банковские и персональные данные плательщика. При оплате заказа банковской картой возврат
                        денежных средств производится на ту же самую карту, с которой был произведён платёж.
                    </Text>
                    <Text textType="h3" tagType="h3">
                        Возврат
                    </Text>
                    ...
                    <Text textType="text" tagType="p">
                        ООО “Lorem Ipsum”
                        <br /> Адрес организации: 195197, г. Санкт-Петербург,пр. Кондратьевский, д. 15, корп. 5, стр. 1,
                        пом.3Н, офис 105
                        <br /> ИНН: 7805657240
                        <br /> КПП: 780501001
                        <br /> ОГРН: 1147847286630
                    </Text>
                </div>
            </div>
            <Footer />
